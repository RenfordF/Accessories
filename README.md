...
```
Check out [FRONTEND LIVE DEMO](https://renford-frontend-accessories.herokuapp.com/) here!!
Check out [API LIVE DEMO](https://renford-backend-accessories.herokuapp.com/) here!!
...
1. Git Clone
```
git clone https://github.com/RenfordF/Accessories.git
```
2. Backend setting
```
cd backend
